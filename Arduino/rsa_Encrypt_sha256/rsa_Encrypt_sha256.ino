...
unsigned long StartTime, CurrentTime,ElapsedTime;
  ...
  long *rsa_encrypted;  long *rsa_encrypted_SHA;
  long *rsa_decrypted;
...
#include <string.h>
#include "sha256.h"
//teste de encriptacao/decriptacao simples RSA + SHA256
/*
...
void loop() {
  ...
  rsa_encrypted_SHA = rsa_encrypt((char *) hash, RSA_Own_Public_Key);
  CurrentTime=micros();
